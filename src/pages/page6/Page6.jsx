...
const Page6 = () => {
    ...
    useEffect(() => {
        const images = [
            'assets/page6/page6-img1.jpg',
            'assets/page6/page6-img2.jpg',
            'assets/page6/page6-img3.jpg',
            'assets/page6/page6-sel1.jpg',
            'assets/page6/page6-sel2.jpg',
            'assets/page6/page6-sel3.jpg',
        ];
        ...
        <div className='w-screen h-auto lg:px-[10%]'>
            ...
            <div className='relative w-full h-full'>
                <img
                    ...
                    alt={`Selected variant image ${select}`}
                />
                <div className='w-full h-[100px] flex items-center justify-end bottom-[0%] bg-text-gray-custom'>
                    <div
                        className={`w-[100px] h-[60px] cursor-pointer ${select === 1 ? 'border-2 border-solid border-black' : ''}`}
                        onClick={() => changeSelect(1)}
                    >
                        <img
                            src='assets/page6/page6-sel1.jpg'
                            className='w-full h-full'
                            alt='Light White/M Motorsport'
                        />
                    </div>
                    <div
                        className={`w-[100px] h-[60px] cursor-pointer ${select === 2 ? 'border-2 border-solid border-black' : ''}`}
                        onClick={() => changeSelect(2)}
                    >
                        <img
                            src='assets/page6/page6-sel2.jpg'
                            className='w-full h-full'
                            alt='Blackstorm metallic'
                        />
                    </div>
                    <div
                        className={`w-[100px] h-[60px] cursor-pointer ${select === 3 ? 'border-2 border-solid border-black' : ''}`}
            ...
            <div className='bg-white flex flex-col-reverse items-center justify-between lg:flex-row px-[10%] my-[5%] gap-[5%]'>
                <div>
                    ...
                    <p className='w-full lg:w-[550px]'>
                        No matter which variant you choose: in this case, not millimeters or milliseconds are crucial,
                    ...
                    <div className='px-[5%]'>
                        {
                            ...
                            select === 3 ? "On the attack: The paint in Bluestone Metallic exudes confidence with an ultra-sporty aesthetic. The dynamic highlights in Racing Red emphasize this bike's potential. Now it’s up to you to walk the walk." :
                            ""
                        }
                    </div>
                </div>
